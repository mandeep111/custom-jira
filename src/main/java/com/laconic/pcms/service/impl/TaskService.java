...
public class TaskService implements ITaskService {
    ...
    public TaskService(ITaskRepo taskRepo, CommonComponent commonComponent, ITagRepo projectTagRepo, IUserRepo userRepo) {
...
//        project.setCompany(company);
    ...
    public TaskResponse getById(Long id) {
        ...
        return convertObject(result, TaskResponse.class);
    }
    ...
    public PaginationResponse<TaskResponse> getAll(int pageNo, int pageSize, String sortBy, String sortDir, String keyword, List<String> searchAttributes) {
        ...
        return getPaginationResponse(page, TaskResponse.class);
    }

    @Override
    public List<TaskResponse> getAll() {
        var result = this.taskRepo.findAll();
        return convertList(result, TaskResponse.class);
    }
