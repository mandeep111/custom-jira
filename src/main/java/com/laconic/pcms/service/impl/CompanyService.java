...
public class CompanyService implements ICompanyService {
    ...
    public PaginationResponse<CompanyResponse> list(int pageNo, int pageSize, String sortBy, String sortDir, String keyword, List<String> searchAttributes) {
        ...
        Page<Company> page;
        if (keyword != null) {
            var specs = CommonComponent.getSpecification(Company.class, COMPANY, keyword, searchAttributes);
            page = this.companyRepo.findAll(specs, pageable);
        } else page = this.companyRepo.findAll(pageable);
