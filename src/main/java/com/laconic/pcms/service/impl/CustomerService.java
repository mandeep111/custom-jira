...
public class CustomerService implements ICustomerService {
    ...
    public PaginationResponse<CustomerResponse> getAll(int pageNo, int pageSize, String sortBy, String sortDir, String keyword, List<String> searchAttributes) {
        ...
        Page<Customer> page;
        if (keyword != null) {
            var specs = CommonComponent.getSpecification(Customer.class, CUSTOMER, keyword, searchAttributes);
            page = this.customerRepo.findAll(specs, pageable);
        } else page = this.customerRepo.findAll(pageable);
