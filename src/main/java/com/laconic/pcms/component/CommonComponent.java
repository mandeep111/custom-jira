...
public class CommonComponent {
    ...
    public <T> Page<T> findAllEntities(Class<T> entityType, String entityName, String keyword, List<String> searchAttributes, Pageable pageable) {
        ...
        if (keyword != null) {
            ...
            Specification<T> specification = getSpecification(entityType, entityName, keyword, searchAttributes);
    ...
    @NotNull
    public static <T> Specification<T> getSpecification(Class<T> entityType, String entityName, String keyword, List<String> searchAttributes) {
    ...
    public static boolean isBooleanProperty(Class<?> entityType, String attributeName) {
        try {
    ...
    private <T> JpaRepository<?, Long> getRepository(Class<T> entityType, String entityName) {
        if (entityType.equals(Company.class)) {
            ...
            return spaceRepo;
        } else if (entityType.equals(SubTask.class)) {
            return subTaskRepo;
        } else if (entityType.equals(Folder.class)) {
            return folderRepo;
        } else {
