...
public class TaskController {
    ...
    public ResponseEntity<List<TaskResponse>> getAll() {
        return ResponseEntity.ok().body(this.projectTaskService.getAll());
    }
    ...
    @GetMapping("/duplicate/{taskId}")
    public ResponseEntity<TaskResponse> duplicate(@PathVariable Long taskId) {
        return ResponseEntity.ok().body(this.projectTaskService.duplicateTask(taskId));
    }
}
