...
public class TaskStageController {
    ...
    public ResponseEntity<List<TaskStageResponse>> getByProject(@PathVariable Long projectId) {
        return ResponseEntity.ok(this.taskTypeService.getByProject(projectId));
    }
